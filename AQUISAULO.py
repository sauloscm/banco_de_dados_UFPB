...
def menu_inserir(cliente):
    try:    
        ...
        print("Erro ao inserir um cliente",e)
...
def menu_atualizar(cliente):
    try:    
        ...
        print("Erro atualizar um cliente",e)
...
def menu_atualizar_funcionario(funcionario):
    try:    
        ...
        print("Erro ao atualizar um funcionario",e)
...
def menu_listar_todos_funcionario(funcionario):
    try:    
        ...
        print("Erro ao listar todos os funcionarios",e)
...
def menu_inserir_produto(produto):
    try:    
        ...
        print("Erro ao inserir um produto",e)
...
def menu_atualizar_produto(produto):
    ...
    try:    
        ...
        print("Erro ao atualizar um produto",e)
...
def menu_inserir_itens_venda(itens_venda):
    try:    
        ...
        print("Erro ao inserir item na venda",e)
...
def menu_listar_todos_itens_venda(itens_venda):
    try:    
        ...
        print("Erro ao exibir todos os itens",e)
...
def menu_inserir_vendas(vendas):
    try:
        ...
        print("Erro ao inserir uma venda",e)
...
def menu_atualizar_vendas(vendas):
    try:
        ...
        print("Erro ao atualizar vendas",e)
